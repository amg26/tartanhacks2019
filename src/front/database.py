...
class User(db.Model):
	...
	langy = db.Column(db.String(80), unique=False)
	idea = db.Column(db.String(80), unique=False)
	exp = db.Column(db.String(80), unique=False)
	plant = db.Column(db.String(80), unique=False)
